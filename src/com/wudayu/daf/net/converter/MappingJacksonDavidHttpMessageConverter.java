package com.wudayu.daf.net.converter;
 ...
 * @Created Time: Oct 31, 2014, 3:47:26 PM
 ...
 * 
 * <p>
 * Tested against Jackson 2.3; compatible with Jackson 2.0 and higher. Note that
 * tests failed with Jackson 2.4 on Android 2.2 (API Level 8) and older
 * versions. Jackson 2.4 uses APIs not available on those platforms.
 * 
 * @author David Wu
 * @since 1.0.1
 */
